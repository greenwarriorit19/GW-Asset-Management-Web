...
| `src/pages/` | 14 modules (Dashboard, Asset Tracker, Registration, Bulk Import, Inventory, Handover, Return, Transfer, Repair, Incidents, Disposal, Reports, Users, Audit Log, Documents) |
...
2. Serial / IMEI / SIM duplicate check on registration and edit; which of them are required follows the asset category (SIM card → SIM number, phone → IMEI, everything else → serial only); mobile devices also carry an MDM registration flag
