...
export function loadSampleData(store: Store): string {
  ...
  const ids = store.importAssets([
    { ...base, categoryId: cat('MOB'), name: 'Samsung Galaxy A35', manufacturer: 'Samsung', model: 'SM-A356E', serialNumber: `SMP-${tag}-M1`, imei: `35${tag}0000001`, sim: `8991${tag}0001`, invoiceNumber: 'PV/2026/1001', purchaseCost: 24999, specification: '8 GB RAM / 128 GB', accessories: 'Charger - 25W, USB-C cable, Back case' },
    { ...base, categoryId: cat('MOB'), name: 'Samsung Galaxy A35', manufacturer: 'Samsung', model: 'SM-A356E', serialNumber: `SMP-${tag}-M2`, imei: `35${tag}0000002`, sim: `8991${tag}0002`, invoiceNumber: 'PV/2026/1001', purchaseCost: 24999, specification: '8 GB RAM / 128 GB', accessories: 'Charger - 25W, USB-C cable' },
    { ...base, categoryId: cat('MOB'), name: 'Redmi Note 13', manufacturer: 'Xiaomi', model: '23124RA7EO', serialNumber: `SMP-${tag}-M3`, imei: `86${tag}0000003`, sim: `8991${tag}0003`, invoiceNumber: 'PV/2026/1002', purchaseCost: 17999, specification: '6 GB RAM / 128 GB', accessories: 'Charger - 33W, Case' },
    { ...base, categoryId: cat('LAP'), name: 'Dell Latitude 5540', manufacturer: 'Dell', model: 'Latitude 5540', serialNumber: `SMP-${tag}-L1`, imei: `DL${tag}0000001`, invoiceNumber: 'DELL-IN-44821', purchaseCost: 78500, specification: 'i5-1335U / 16 GB / 512 GB SSD', accessories: 'Charger - 65W, Laptop bag, Wireless mouse' },
    { ...base, categoryId: cat('LAP'), name: 'HP ProBook 450 G10', manufacturer: 'HP', model: 'ProBook 450 G10', serialNumber: `SMP-${tag}-L2`, imei: `HP${tag}0000002`, invoiceNumber: 'CPP/2026/0331', purchaseCost: 64200, specification: 'i5-1334U / 8 GB / 512 GB SSD', accessories: 'Charger - 65W, Bag' },
    { ...base, categoryId: cat('TAB'), name: 'Samsung Galaxy Tab A9+', manufacturer: 'Samsung', model: 'SM-X210', serialNumber: `SMP-${tag}-T1`, imei: `35${tag}0000004`, sim: `8991${tag}0004`, invoiceNumber: 'PV/2026/1003', purchaseCost: 18999, specification: '11-inch, 8 GB / 128 GB', accessories: 'Charger, Cover' },
    ...
    { ...base, categoryId: cat('CAM'), name: 'Body Camera BC-200', manufacturer: 'Hikvision', model: 'DS-MH2311', serialNumber: `SMP-${tag}-C1`, imei: `HK${tag}0000006`, invoiceNumber: 'SVS/2026/2210', purchaseCost: 15800, specification: '1080p, 64 GB, 8h battery', accessories: 'Dock, Clip, Charger' },
    { ...base, categoryId: cat('SIM'), name: 'Airtel Corporate SIM', manufacturer: 'Airtel', model: 'Prepaid Corporate', serialNumber: `SMP-${tag}-S1`, imei: `SIM${tag}000007`, sim: `8991${tag}0007`, invoiceNumber: 'AIR/2026/CP-118', purchaseCost: 0, specification: 'Corporate plan 2 GB/day', accessories: '' },
    { ...base, categoryId: cat('FUR'), name: 'Executive Office Chair', manufacturer: 'Featherlite', model: 'Contact Project', serialNumber: `SMP-${tag}-F1`, imei: `FL${tag}0000008`, invoiceNumber: 'FF/2026/3391', purchaseCost: 9800, specification: 'High back, mesh', accessories: '' },
  ], reason);
